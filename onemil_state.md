...
- **Zatím neprovedeno (další kroky issue #289):** odstranění panelu z Homepage a partnerský blok na Homepage (část B). Dobíjecí komponenta je dočasně na obou místech (Homepage i `/top-up`) — jeden sdílený zdroj.
