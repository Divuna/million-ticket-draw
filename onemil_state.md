...
**Mimo aktuálně hotový staging rozsah:** Edge Function `generate-affiliate-bank-export` (Fáze D) zatím NEdeployována — čeká na výslovné schválení Pavla. Potvrzení o zaplacení (Fáze E) zatím není hotové. Produkční rollout zůstává odložený na koordinovaný balík DB + aktuální UI + smoke test.
