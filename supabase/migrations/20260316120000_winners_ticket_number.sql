-- Add ticket_number to get_latest_winners for Winners page display.
-- Read-only reporting function; no contest engine logic changed.
...
BEGIN
  ...
  SELECT 
    ...
    COALESCE(t.number, bp.ticket_position)::integer AS ticket_number
  FROM winners w
