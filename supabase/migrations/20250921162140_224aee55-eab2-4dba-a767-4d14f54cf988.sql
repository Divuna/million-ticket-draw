-- Create comprehensive test functions for OneMil platform
...
BEGIN
  ...
  BEGIN
    ...
    v_test_results := v_test_results || json_build_object(
      ...
      'status', 'passed',
      'message', 'Test uživatel test@onemil.cz byl úspěšně vytvořen',
