-- Feed unified notification pipeline (event_logs → notifications → push) when
-- winners are created and contests close. Column is event_name (not event_type).
-- Only adds INSERT INTO public.event_logs; audit_logs and other logic unchanged.

-- =============================================================================
-- buy_ticket_atomic — event_logs for prize_won (bonus/main) + contest_closed
-- =============================================================================
...
-- =============================================================================
-- close_contest — event_logs for prize_won + contest_closed
-- =============================================================================
