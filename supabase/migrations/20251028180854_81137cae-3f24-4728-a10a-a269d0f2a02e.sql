-- Create diagnostic function to test Sofinity player synchronization
-- Auto-detects http_post (pg_http) or net.http_post (pg_net) and adapts accordingly
...
'Diagnostic function to test Sofinity player sync endpoint. Auto-detects available HTTP extension (pg_http or pg_net) and sends test request.';
