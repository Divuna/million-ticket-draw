...
-- Create a function to get latest winners that bypasses RLS
-- This is safe because it only returns public display data (no sensitive info)
...
GRANT EXECUTE ON FUNCTION public.get_latest_winners(INTEGER) TO anon, authenticated;
;
