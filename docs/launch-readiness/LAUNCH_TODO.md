...
| ID | Prio | Oblast | Krok | Očekávaný výsledek | Skutečný | Odkaz | Důkaz | Stav | Pozn. |
|----|------|--------|------|--------------------|----------|-------|-------|------|-------|
| SEC01 | P0 | Security advisor backlog | Projít a uzavřít/akceptovat nálezy Security Advisoru | Každý nález fixnut nebo výslovně akceptován ownerem | **PRODUKCE (schválení Pavla): Group 1 (23→10) + Group 2 safe/interim (10→8) + E09 security_invoker (8→7) hotové a ověřené. E09: postcheck invoker on, output 127/101 nezměněn, P0 smoke `27512629715` success. Zbývá 7 ERROR (E05, E23 + Group 3) — vše Security Definer View.** | [SECURITY_FINDINGS.md](./SECURITY_FINDINGS.md) | prod advisor 8→7 + smoke 27512629715 | **selhalo (blocker)** | **P0 blocker: produkce 7 ERROR; E05/E23 potřebují tickets admin-read policy nebo accept; Group 3 (E17–E20/E22); WARN/INFO** |
