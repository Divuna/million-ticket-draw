...
| ID | Prio | Oblast | Krok | Očekávaný výsledek | Skutečný | Odkaz | Důkaz | Stav | Pozn. |
|----|------|--------|------|--------------------|----------|-------|-------|------|-------|
| SEC01 | P0 | Security advisor backlog | Projít a uzavřít/akceptovat nálezy Security Advisoru | Každý nález fixnut nebo výslovně akceptován ownerem | **Group 1 + Group 2 safe/interim hotové na STAGINGU I PRODUKCI (schválení Pavla). Produkce: Group 1 advisor 23→10; Group 2 (migrace `sec01_group2_safe_interim_hardening`) advisor 10→8 (E03+E14 cleared, E05/E09/E23 anon revoked, SDV ERROR zůstává); P0 smoke `27511945205` success (5 passed), bez rollbacku. Zbývá 8 ERROR (vše Security Definer View) + WARN/INFO.** | [SECURITY_FINDINGS.md](./SECURITY_FINDINGS.md) | prod advisor 10→8 + smoke 27511945205 + E2E 27511465619 | **selhalo (blocker)** | **P0 blocker stále platí: 8 ERROR na produkci; E05/E09/E23 security_invoker (owner decision), E03 volitelný DROP, Group 3 (E17–E20/E22), WARN/INFO zbývají** |
