...
| ID | Prio | Oblast | Krok | Očekávaný výsledek | Skutečný | Odkaz | Důkaz | Stav | Pozn. |
|----|------|--------|------|--------------------|----------|-------|-------|------|-------|
| SEC01 | P0 | Security advisor backlog | Projít a uzavřít/akceptovat nálezy Security Advisoru | Každý nález fixnut nebo výslovně akceptován ownerem | **Group 1 (11 views) hotov na STAGINGU I PRODUKCI (prod advisor 23→10, smoke 27511158470). Group 2 safe/interim OVĚŘEN NA STAGINGU 14.06 (migrace `sec01_group2_safe_interim_hardening`): E03+E14 cleared, E05/E09/E23 anon revoked (SDV ERROR zůstává); staging advisor 10→8; Full E2E `27511465619` = 122 passed/0 fail. PRODUKCE pro Group 2 NEDOTČENA.** | [SECURITY_FINDINGS.md](./SECURITY_FINDINGS.md) | advisor staging 10→8 + E2E 27511465619 | **selhalo (blocker)** | **P0 blocker stále platí: na produkci 10 ERROR; Group 2 zatím jen staging; E05/E09/E23 security_invoker + E03 prod/DROP + Group 3 + WARN/INFO zbývají** |
