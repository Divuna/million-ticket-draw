...
| ID | Prio | Oblast | Krok | Očekávaný výsledek | Skutečný | Odkaz | Důkaz | Stav | Pozn. |
|----|------|--------|------|--------------------|----------|-------|-------|------|-------|
| SEC01 | P0 | Security advisor backlog | Projít a uzavřít/akceptovat nálezy Security Advisoru | Každý nález fixnut nebo výslovně akceptován ownerem | **PRODUKCE (schválení Pavla): E18 partner-own RLS redesign hotov (migrace `sec01_e18_partner_api_activity_partner_own_rls`; prod advisor 3→2; P0 smoke `27528174542` success). Zbývají 2 ERROR: E17 (`v_influencer_referrals_paid`, affiliate-scoped RLS redesign — NO-GO blind) a E22 (`contest_progress`, formální owner-accept). Progrese prod ERROR: 23→10→8→7→5→3→2.** | [SECURITY_FINDINGS.md](./SECURITY_FINDINGS.md) | prod advisor 3→2 + smoke 27528174542 | **selhalo (blocker)** | **P0 blocker: produkce 2 ERROR — E17 redesign (reader audit + privacy review) + E22 formální owner-accept; + WARN/INFO** |
