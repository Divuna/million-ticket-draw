...
| ID | Prio | Oblast | Krok | Očekávaný výsledek | Skutečný | Odkaz | Důkaz | Stav | Pozn. |
|----|------|--------|------|--------------------|----------|-------|-------|------|-------|
| SEC01 | P0 | Security advisor backlog | Projít a uzavřít/akceptovat nálezy Security Advisoru | Každý nález fixnut nebo výslovně akceptován ownerem | **STAGING: E17 affiliate-scoped redesign OVĚŘEN (migrace `sec01_e17_influencer_referrals_paid_affiliate_scoped`) — owner+admin RLS, 2 minimal-disclosure helpers, invoker view; advisor E17 gone (2→1), E2E `27528853194` 122 passed. Staging effective unresolved = 0 (zbývá jen E22, accepted). PRODUKCE: stále 2 raw ERROR (E17 čeká prod schválení, E22 accepted) → efektivní nevyřešený prod ERROR = 1 (E17). Po prod rolloutu E17 lze SEC01 uzavřít.** | [SECURITY_FINDINGS.md](./SECURITY_FINDINGS.md) | staging advisor E17 gone + E2E 27528853194 | **selhalo (blocker)** | **P0 blocker kvůli E17 (čeká prod schválení). E22 accepted. Po prod E17 → SEC01 uzavřitelný (mimo WARN/INFO).** |
