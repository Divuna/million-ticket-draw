...
| ID | Prio | Oblast | Krok | Očekávaný výsledek | Skutečný | Odkaz | Důkaz | Stav | Pozn. |
|----|------|--------|------|--------------------|----------|-------|-------|------|-------|
| SEC01 | P0 | Security advisor backlog | Projít a uzavřít/akceptovat nálezy Security Advisoru | Každý nález fixnut nebo výslovně akceptován ownerem | **Group 1 (11 views) APLIKOVÁN + OVĚŘEN NA STAGINGU I PRODUKCI 14.06 (schválení Pavla). Produkce: precheck=baseline → forward SQL → postcheck 11/11 → advisor ERROR 23→10 → P0 smoke `27511158470` success (5 passed), bez rollbacku. Zbývá 10 ERROR (1 RLS Disabled in Public + 9 Security Definer View = Group 2/3) + WARN/INFO.** | [SECURITY_FINDINGS.md](./SECURITY_FINDINGS.md) | advisor prod + smoke 27511158470 + E2E 27510668205 | **selhalo (blocker)** | **P0 blocker stále platí: Group 1 hotov (prod), ale 10 ERROR (Group 2/3) + WARN/INFO zbývá; vyžadují fix nebo owner-accept** |
