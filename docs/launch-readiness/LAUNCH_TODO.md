...
| ID | Prio | Oblast | Krok | Očekávaný výsledek | Skutečný | Odkaz | Důkaz | Stav | Pozn. |
|----|------|--------|------|--------------------|----------|-------|-------|------|-------|
| SEC01 | P0 | Security advisor backlog | Projít a uzavřít/akceptovat nálezy Security Advisoru | Každý nález fixnut nebo výslovně akceptován ownerem | **PRODUKCE: 3 ERROR (E17, E18, E22). STAGING navíc: E18 partner-own RLS redesign OVĚŘEN (migrace `sec01_e18_partner_api_activity_partner_own_rls`) — partner_api_requests_partner_own + security_invoker; staging advisor 3→2; E2E `27527383016` 122 passed (spec 47 green). E18 připraven pro prod schválení. Produkce pro E18 NEDOTČENA.** | [SECURITY_FINDINGS.md](./SECURITY_FINDINGS.md) | staging advisor 3→2 + E2E 27527383016 | **selhalo (blocker)** | **P0 blocker: produkce 3 ERROR; E18 čeká prod schválení; E17 affiliate-scoped RLS redesign; E22 formální owner-accept; + WARN/INFO** |
