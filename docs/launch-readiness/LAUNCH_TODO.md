...
| L05 | P0 | Kontakt | Reálné údaje | Dle COMPANY_CONTEXT.md | Owner potvrzeno: kanonický veřejný support e-mail je `podpora@onemil.cz`; app/legal/contact/footer/delete-account/support fallback i `COMPANY_CONTEXT.md` jsou sjednocené | /kontakt, /terms, /privacy, /delete-account, footer | owner decision + docs audit 14.06. | prošlo | Public support e-mail consistency resolved; právní kvalita ostatních textů zůstává v L01-L04 |
