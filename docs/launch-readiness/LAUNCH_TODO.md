...
| ID | Prio | Oblast | Krok | Očekávaný výsledek | Skutečný | Odkaz | Důkaz | Stav | Pozn. |
|----|------|--------|------|--------------------|----------|-------|-------|------|-------|
| SEC01 | P0 | Security advisor backlog | Projít a uzavřít/akceptovat nálezy Security Advisoru | Každý nález fixnut nebo výslovně akceptován ownerem | **PRODUKCE (schválení Pavla): Group 1+2+E09+E05/E23+Group 3 hotové. Group 3 (migrace `sec01_group3_safe_interim_hardening`): E19+E20 cleared (revoke+invoker), E17+E18 zůstávají interim (anon na prod už byl false; redesign pending), E22 ponechán (owner-accept candidate). Prod advisor 5→3; P0 smoke `27526912855` success. Zbývají 3 ERROR: E17, E18, E22.** | [SECURITY_FINDINGS.md](./SECURITY_FINDINGS.md) | prod advisor 5→3 + smoke 27526912855 | **selhalo (blocker)** | **P0 blocker: produkce 3 ERROR — E18 partner-own RLS redesign, E17 affiliate-scoped RLS redesign, E22 formální owner-accept; + WARN/INFO. Progrese prod ERROR: 23→10→8→7→5→3.** |
