...
| ID | Prio | Oblast | Krok | Očekávaný výsledek | Skutečný | Odkaz | Důkaz | Stav | Pozn. |
|----|------|--------|------|--------------------|----------|-------|-------|------|-------|
| SEC01 | P0 | Security advisor backlog | Projít a uzavřít/akceptovat nálezy Security Advisoru | Každý nález fixnut nebo výslovně akceptován ownerem | **PRODUKCE (schválení Pavla): Group 1 (23→10) + Group 2 safe/interim (10→8) + E09 security_invoker (8→7) hotové. STAGING navíc: E05/E23 vyřešeno — `tickets_admin_select_all` policy + security_invoker (migrace `sec01_e05_e23_tickets_admin_read_and_invoker`); staging advisor 7→5; E2E `27512846743` 122 passed; output 7/789/1153 nezměněn. Produkce pro E05/E23 security_invoker NEDOTČENA (jen interim anon-revoke). Zbývajících 5 ERROR na stagingu = Group 3.** | [SECURITY_FINDINGS.md](./SECURITY_FINDINGS.md) | staging advisor 7→5 + E2E 27512846743 | **selhalo (blocker)** | **P0 blocker: produkce 7 ERROR; E05/E23 čekají prod schválení; Group 3 (E17–E20/E22); WARN/INFO** |
