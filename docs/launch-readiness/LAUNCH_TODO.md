...
| ID | Prio | Oblast | Krok | Očekávaný výsledek | Skutečný | Odkaz | Důkaz | Stav | Pozn. |
|----|------|--------|------|--------------------|----------|-------|-------|------|-------|
| SEC01 | P0 | Security advisor backlog | Projít a uzavřít/akceptovat nálezy Security Advisoru | Každý nález fixnut nebo výslovně akceptován ownerem | **Inventář 14.06: 467 nálezů prod (23 ERROR / 20 INFO / 424 WARN). Group 1 (11 app-unused SECURITY DEFINER views) APLIKOVÁN + OVĚŘEN NA STAGINGU 14.06: revoke anon/auth + security_invoker; advisor staging 11 ERRORů zmizelo (21→10); Full E2E `27510668205` = 121 passed / 0 fail. PRODUKCE NEDOTČENA (stále 23 ERROR). Group 2/3 (10 ERROR) zbývá.** | [SECURITY_FINDINGS.md](./SECURITY_FINDINGS.md) | advisor staging + E2E 27510668205 | **selhalo (blocker)** | **P0 blocker stále platí: prod neopraven, 10 ERROR (Group 2/3) zbývá; produkční fix vyžaduje samostatné schválení ownera** |
