          ...
          >
            {vouchersLoading ? (
              ...
              homepageVouchers.map((voucher) => (
                  ...
                  <Card className="voucher-card-glow relative overflow-hidden rounded-[20px] bg-[hsl(220_45%_6%)] border-[3px] border-[hsl(40_30%_35%)] shadow-[0_4px_16px_hsl(222_50%_3%/0.5)] transition-all duration-300 hover:border-[hsl(40_40%_45%)] hover:shadow-[0_0_12px_hsl(40_30%_40%/0.2)] hover:scale-[1.02]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {partnersLoading ? (
              ...
              partners.map((partner) => (
                <div
                  key={partner.id}
                  className="voucher-card-glow aspect-square bg-[hsl(40_15%_10%)] border-[3px] border-[hsl(40_30%_35%)] rounded-[20px] overflow-hidden cursor-pointer transition-all duration-300 hover:border-[hsl(40_40%_45%)] hover:shadow-[0_0_12px_hsl(40_30%_40%/0.2)] shadow-[0_4px_16px_hsl(222_50%_3%/0.5)] group"
