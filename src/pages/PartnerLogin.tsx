...
import { Loader2, Building2, ArrowLeft, Mail, Lock, Handshake, TrendingUp, Zap } from 'lucide-react';
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-md flex-col items-center">
        ...
        <div className="om-auth-rise om-auth-rise-3 w-full rounded-[28px] border border-[#F3E4CF] bg-white p-6 shadow-[0_20px_60px_-24px_rgba(26,20,10,0.25)] sm:p-8">
          <div className="mb-6 flex flex-col items-center text-center">
            ...
            <h2 className="font-heading text-xl font-bold text-[#1A1A1A]">Přihlášení partnera</h2>
            <p className="mt-1 text-sm text-[#8A8A8A]">Přihlaste se do svého partnerského účtu</p>
          </div>
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-sm text-[#8A8A8A]">
              ...
              <Link to="/partner/register" className="font-medium text-[#C2570A] hover:underline">
                Registrovat e-shop
              </Link>
            </p>
            <Link
