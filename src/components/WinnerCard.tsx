...
export const WinnerCard = ({ 
  ...
  return (
    <Card className="rounded-xl overflow-hidden bg-card/40 backdrop-blur-sm border border-border/50 hover:bg-card hover:border-primary/40 hover:shadow-lg hover:shadow-primary/10 hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 cursor-pointer relative">
      ...
      <div className="flex relative z-10">
        ...
        <div className="w-[35%] flex-shrink-0 bg-muted/30 flex items-center justify-center overflow-hidden">
          {prizeImageUrl ? (
            <img 
              src={prizeImageUrl} 
              alt={prizeName} 
