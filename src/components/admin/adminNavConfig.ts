...
const USERS_NAV = {
  ...
  affiliateSystem: { path: "/admin/affiliate", label: "Affiliate systém", icon: Megaphone },
    ...
    subNavEntries: [
      ...
      { kind: "link", item: USERS_NAV.influencers },
      {
        ...
        sections: [
          ...
          { label: "Affiliate", items: [USERS_NAV.affiliateSystem, USERS_NAV.campaigns, USERS_NAV.commissions] },
          {
...
export function getAdminSectionFromPath(pathname: string, search: string = ""): AdminNavSectionId {
  ...
  if (
    ...
    path.startsWith("/admin/affiliate") ||
