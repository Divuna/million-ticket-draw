      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 flex flex-col gap-2">
        ...
        {user && !isAdmin && (
          <div className="flex gap-2 mt-2">
            <button
              className="flex-1 py-2.5 px-4 bg-[hsl(220_45%_8%)] text-[hsl(45_93%_60%)] font-bold rounded-lg border border-[hsl(45_93%_50%/0.3)] shadow-[0_0_12px_hsl(45_93%_50%/0.15)] hover:shadow-[0_0_20px_hsl(45_93%_50%/0.25)] hover:border-[hsl(45_93%_50%/0.5)] hover:brightness-110 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none text-sm"
