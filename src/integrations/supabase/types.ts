...
export type Database = {
  ...
  public: {
    Tables: {
      _backup_vereonika_bad_codes_20260817: {
        Row: {
          ...
          status: Database["public"]["Enums"]["partner_code_status"] | null
        }
        Insert: {
          activated_at?: string | null
          activated_by_user_id?: string | null
      ...
      sales_lead_magin_morning_discovery_jobs: {
        Row: {
        ...
        Relationships: [
          {
            foreignKeyName: "sales_lead_magin_morning_discovery_jobs_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: true
            referencedRelation: "sales_lead_discovery_jobs"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      admin_mark_partner_invoice_paid: {
      ...
      admin_set_partner_commercial_terms: {
        Args: {
          p_partner_id: string
      ...
      format_miocoin_cz: { Args: { p_value: number }; Returns: string }
      ...
      is_admin_for_rls: { Args: never; Returns: boolean }
      ...
      miocoin_min_partner_reward_mc: { Args: never; Returns: number }
      ...
      sales_lead_magin_create_next_e_shopy_morning_discovery_job: {
        Args: { p_actor_user_id: string; p_target_count: number }
        Returns: Json
      }
