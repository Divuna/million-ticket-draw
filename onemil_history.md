# 03. 08. 2026 — Zpevnění Stripe refundací (Draft PR, nenasazeno)

- **Pouze Draft PR — produkce `xkzhjldrojjlrkezorey` nebyla změněna.** Migrace není aplikovaná na žádné databázi, Edge Function `stripe-refund` zůstává na produkci ve verzi 135, žádná skutečná refundace neproběhla, žádná testovací platba nevznikla.
