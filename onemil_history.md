...
- Kontroly: `npx tsc --noEmit` exit 0, `npm run build` exit 0, read-only integritní dotazy bez nálezu. Migrace nebyla spuštěna na žádné databázi (lokálně chybí Docker i psql; Supabase branch je placená, staging neschválený).
